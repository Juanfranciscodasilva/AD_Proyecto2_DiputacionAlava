...
//    }
//    
//    public static Response eliminarInscripcionByCampamentoIdAndPersonaId(int idCampamento, String dniPersona){
//        Response respuesta = new Response();
//        try{
//            instanciarFichero();
//            deleteByCampamentoIdAndPersonaId(idCampamento,dniPersona); 
//        }catch(Exception ex){
//            System.out.println(ex.getMessage());
//            respuesta.setCorrecto(false);
...
//    }
//    
//    private static void deleteByCampamentoIdAndPersonaId(int idCampamento, String dniPersona) throws Exception{
//        try {
////            List<CampamentoPersona> inscripciones = getListaInscripcionesFromBD();
